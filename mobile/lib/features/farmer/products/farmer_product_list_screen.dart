...
class _ProductGridCard extends StatelessWidget {
  ...
  const _ProductGridCard({required this.productId, required this.data});
          ...
          children: [
             ...
             Expanded(
                child: Container(
                   ...
                   child: Stack(
                      children: [
                         // [NEW] CommonImage (Base64/Network)
                         SizedBox(
                            width: double.infinity,
                         ...
                         children: [
                            Column(
                               ...
                               children: [
                                  ...
                                  if (isStockOut)
                                     Text(
                                        LocalizationService.tr('stock_out_en'), // Short text preferred
                            ...
                            InkWell(
                               onTap: isStockOut ? null : () {
                                  context.read<CartProvider>().addItem(
                                     ...
                                     nameTa: nameTa,
                                     nameEn: nameEn,
                                     price: _calculateOfferPrice(data), // Use final price
                                     unitTa: unitTa,
                                     unitEn: unitEn,
                                     imageUrl: data['imageUrl'] as String?,
                                  );
